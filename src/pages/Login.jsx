                ...
                <div className=" flex flex-col items-start justify-start bg-white max-w-[450px] w-full h-fit shadow-lg shadow-slate-500/90 rounded-[18px]  p-4 md:p-8 gap-5">
                    ...
                    <div className="w-full flex flex-col items-start justify-center gap-2">
                        ...
                        <div className=" w-full flex flex-col items-start justify-center h-fit py-3 gap-1">
                            ...
                            <input value={email} onChange={ (e) => setEmail(e.target.value)} type="email" className="w-full font-extralight  border border-[#9c9c9c] bg-[#fcfcfc] outline-none text-base rounded-[6px] p-2 " />
                        </div>
                        <div className=" w-full flex flex-col items-start justify-center h-fit py-3 gap-1">
                            <label className='text-base font-extralight capitalize text-black ' >password</label>
                            <input value={password} onChange={ (e) => setPassword(e.target.value)} type="password" className="w-full font-extralight  border border-[#9c9c9c] bg-[#fcfcfc] outline-none text-base rounded-[6px] p-2 " />
                        </div>
                    </div>
                    {console.log(errorMsg)}
                    {
